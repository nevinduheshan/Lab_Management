...
<head>
    ...
    <title>Calendar – LAB Manage</title>
            ...
            <div class="row g-0 ">
                <div class="col-md-6">
                    <div class="text-white p-4 p-md-5">
                        ...
                        <div class="footer">
                            <h6 class="mt-3"><span id="dateElement" class=""> </span>
                                <button id="footer-date" class="px-4 py-2  rounded text-hover"
                                        style=" background-color: #F5FE83; color: #000000;">Today
                                </button>
                            </h6>
                        </div>
                        ...
                        <form id="frmselectedDateField" name="frmselectedDateField"
                              action="<%=request.getContextPath()%>/Personal-DoctorForSelectedDate">
                            <input id="loggedusername" name="loggedusername" type="hidden" value="<%=loggedusername%>">
                            <input id="selectedDateField" name="selectedDateField" class="bg-black" type="text"
                                   value="<% if(selectedDateField !=null){out.print(selectedDateField);}%>" readonly>
                        </form>
                ...
                <div class="col-md-6 order-first order-md-last" style="min-height: 250px">
                    ...
                    <div class="body-cal" style="display: flex ">
                        <div class="calendar mptt-main-list" id="calendar-app">
                        ...
                        <script>
                            ...
                            CalendarApp.prototype.showDay = function (e, dayEle) {
                                ...
                                var currentUser = document.getElementById("selectUser").value;
                                ...
                                // chnage request for outclass section
                                if (currentUser === "OurClassSection") {

                                    var currentClass = document.getElementById("selectClass").value;
                                    $.ajax({
                                        type: 'POST',
                                        ...
                                        data: JSON.stringify({
                                            ...
                                            reqClasses: currentClass,
                                        }),
                                        success: function (data) {
                                            if (currentClass == "allClasses") {
