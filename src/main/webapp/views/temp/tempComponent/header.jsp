                            ...
                            <div class="site-branding pbmit-logo-area">
                                <h1 class="site-title">
                                    <a href="<%=request.getContextPath()%>/">
                                        <img src="<%=request.getContextPath()%>/images/demo1/hospitalicon.png" class="logo-img" alt="ABC">
                                    </a>
                                </h1>
                            </div>
                                        ...
                                        <div class="pbmit-menu-wrap">
														...
														<svg class="qodef-svg--close qodef-m" xmlns="http://www.w3.org/2000/svg" width="20.163" height="20.163" viewBox="0 0 26.163 26.163">
															...
															<rect width="36" height="1" transform="translate(0 25.456) rotate(-45)"></rect>
                                                             ...
                                                             <a href="<%=request.getContextPath()%>/index">
                                                                <span class="pbmit-header-button2-text text-black">login</span>
                                                             </a>
													</span>
                                            <ul class="navigation clearfix">
                                                ...
                                                <li class="${activeItem == 'our-classes' ? 'active' : ''}">
                                                    <a href="<%=request.getContextPath()%>/ourclasses" class="our-classes">Appointments</a>
                                                </li>
