...
<head>
    ...
    <script type="text/javascript">
        function scheduleChangeForDoctor(){

            if (confirm("Are you sure you want to change this Doctor schedule ?") == true) {

                document.getElementById("frmScheduleChange").submit();
            }else{
...
<div class="modalX fade" id="exampleModalCenterX" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document"  >
        <form id="frmScheduleChange" name="frmScheduleChange" method="post" action="<%=request.getContextPath()%>/bookDoctor">
            <div class="modal-content " style="background-color: #1E293B;">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="javascript:scheduleChangeForDoctor();" class="btn btn-primary">schedule changes</button>
                </div>
