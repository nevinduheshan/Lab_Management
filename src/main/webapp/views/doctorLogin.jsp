...
<body>
<form action="<%=request.getContextPath()%>/doctorLoginValidate" method="post">
    <div class="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-[#111827]">
        <div class="max-w-md w-full space-y-8">
            <div>
                ...
                <h2 class="mt-6 text-center text-3xl font-extrabold text-white">Doctor Login</h2>
            ...
            <form class="mt-8 space-y-6" action="#" method="POST">
                ...
                <div class="rounded-md shadow-sm -space-y-px">
                    <div>
                        <label for="doctorUsername" class="sr-only">Admin Username</label>
                        <input type="text" placeholder="Username" name="doctorUsername" id="doctorUsername" required
                    ...
                    <div>
                        ...
                        <input id="doctorPassword" name="doctorPassword" type="password" autocomplete="current-password"
                               required
