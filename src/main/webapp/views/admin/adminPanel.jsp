    ...
    <div class="flex-none h-full text-center flex items-center justify-center">
        ...
        <div class="flex space-x-3 items-center">
            <div class="flex-none flex justify-center">
                <p class="mt-1 text-black dark:text-white">ADMIN</p>
...
<aside class="w-60 -translate-x-48 fixed transition transform ease-in-out duration-1000 z-50 flex h-screen bg-[#1E293B] ">
    ...
    <div class="max hidden text-white mt-20 flex-col space-y-2 w-full h-[calc(100vh)]">
        ...
        <a onclick="logoutPopup()">
            <div  class="hover:ml-4 w-full text-white hover:bg-red-700 bg-[#1E293B] p-2 pl-8 rounded-full transform ease-in-out duration-300 flex flex-row items-center space-x-3">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5" >
    ...
    <div class="centered-box ps-5" style="max-width: 480px; width: 85%;">
        ...
        <div class="textSection pt-5 mt-1 pe-5 ps-3" style="max-height: 680px; overflow: auto;">
            ...
            <p class="pt-3 pb-3" id="delText">
                Are you sure you want to log out from the admin panel ? you will be redirected to the landing page.
            </p>
            <div class="mt-4 mb-4">
